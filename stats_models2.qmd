...
There will be dimensions computed equal to the number of variables in the analysis.  Each dimension is orthogonal (uncorrelated) to the others.  But how many of these are meaningful, i.e. how many dimensions or components explain a substantively significant proportion of the variance among these variables?
